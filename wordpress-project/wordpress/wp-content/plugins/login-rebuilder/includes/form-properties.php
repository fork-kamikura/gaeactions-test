...
<ul>
<li><input type="radio" name="properties[notify_siteadmin_cc]" id="properties_notify_siteadmin_cc0" value="0" <?php checked( 0 === $this->properties['notify_siteadmin_cc'] ); ?> />&nbsp;<?php _e( 'Do not specify the site administrator as CC / BCC.', LOGIN_REBUILDER_DOMAIN ); ?></li>
<li><input type="radio" name="properties[notify_siteadmin_cc]" id="properties_notify_siteadmin_cc1" value="1" <?php checked( 1 === $this->properties['notify_siteadmin_cc'] ); ?> />&nbsp;<?php _e( 'Designate the site administrator as CC.', LOGIN_REBUILDER_DOMAIN ); ?></li>
<li><input type="radio" name="properties[notify_siteadmin_cc]" id="properties_notify_siteadmin_cc2" value="2" <?php checked( 2 === $this->properties['notify_siteadmin_cc'] ); ?> />&nbsp;<?php _e( 'Designate the site administrator as BCC.', LOGIN_REBUILDER_DOMAIN ); ?></li>
</ul>
</div>
</td>
</tr>
