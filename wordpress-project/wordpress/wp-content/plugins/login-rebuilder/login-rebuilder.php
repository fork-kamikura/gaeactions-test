...
/*
 Copyright (C) 2013-2020 tmatsuur (Email: takenori dot matsuura at 12net dot jp)
...
define( 'LOGIN_REBUILDER_DB_VERSION', '2.6.9' );
...
<?php
	 ...
	 * @access private.
	 *
	 * @param string $type Log data type( 'invalid', 'login', 'pingback', 'rest' ).
	 */
...
<?php
	...
	public function download_log() {
		if ( current_user_can( 'manage_options' ) && isset( $_POST['type'] ) &&
			in_array( $_POST['type'], array( 'invalid', 'login', 'pingback', 'rest' ) ) ) {
